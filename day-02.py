...
PUZZLE_INPUT = """Game 1: 1 red, 3 blue, 11 green; 1 blue, 5 red; 3 blue, 5 green, 13 red; 6 red, 1 blue, 4 green; 16 red, 12 green
...
def solve(puzzle_input):
    ...
    for line in puzzle_input.split("\n"):
        ...
        for cubeRound in cubes.split(";"):
            cubesSeen = [[nC.strip().split(" ")[1], int(nC.strip().split(" ")[0])] for nC in
                         cubeRound.split(",")]
